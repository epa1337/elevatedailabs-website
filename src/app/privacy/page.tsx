export default function PrivacyPage() {
  return (
    <div className="container max-w-3xl mx-auto py-24 px-4 md:px-6">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold mb-2">Privacy Policy</h1>
        <br />
        <p className="text-sm text-muted-foreground font-semibold">Last updated: January 5, 2025</p>
      </div>
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <strong>Application</strong> refers to any application or software program provided by the Company, including but not
              limited to BookBuddy AI and any other applications or software programs provided by the Company.
            </li>
            <li>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to
              Elevated AI Labs Inc.
            </li>
            <li>
        ...
        <section>
          ...
          <h3 className="text-xl font-semibold mt-6">Business Transactions</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6">Law enforcement</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6">Other legal requirements</h3>
          ...
          <p>By email: <a href="mailto:team@elevatedailabs.com" className="text-blue-600 hover:text-blue-800">team@elevatedailabs.com</a></p>
        </section>
      </div>
    </div>
  );
